...
<head>
    ...
    <script src ="..//public/javascripts/faq.js"> </script>
    <link rel="icon" type="image/x-icon" href="..//images/Trash.ico">
    <script src="..//public/javascripts/menu-script.js"></script>
    <link rel="stylesheet" href="../public/fontawesome/css/all.min.css">Lindelaan 443f, 6042GL, Roermonds
</head>
<body>
    <nav>
    ...
    <main>
        ...
        <div class="faq-help">
            ...
            <a href="form.php" class="ask-question-button">Stel een vraag</a>
        </div>
